            ...
            <div className="h-full w-full lg:w-[50%] relative lg:absolute lg:right-0 flex justify-center">
                <div className="h-full w-full flex flex-col items-center justify-between bg-white">
                        ...
                        <form className="w-full space-y-4" onSubmit={((e) => {
                            ...
                            <div className="flex flex-col lg:flex-row gap-4">
                                <div className="flex flex-col w-full relative">
                                    <label htmlFor="name" className="text-sm font-medium text-neutral-90/80 mb-1">Nome completo</label>
                                ...
                                <div className="flex flex-col w-full relative">
                                    <label htmlFor="matricula" className="text-sm font-medium text-neutral-90/80 mb-1">Matrícula</label>
                                    <input
                                        id="matricula"
                                        type="text"
                                        required
                            ...
                            <div className="flex flex-col lg:flex-row gap-4">
                                <div className="flex flex-col w-full relative">
                                    <label htmlFor="email" className="text-sm font-medium text-neutral-90/80 mb-1">E-mail institucional</label>
                                    <span className="absolute left-2 top-[2.7rem] transform -translate-y-1/2 text-neutral90/70 border-r border-neutral-500"><UserIcon size={20} /></span>
                                    <input
                                        id="email"
                                        type="email"
                            ...
                            <div className="flex flex-col w-full">
                                <label htmlFor="curso" className="text-sm font-medium text-neutral-90/80 mb-1">Curso</label>
                                <select
                                    id="curso"
                                    value={curso}
                                    required
                            ...
                            <div className="text-sm mt-2 text-neutral90/60 font-secundaria flex justify-between w-full">
                                <p className="font-secundaria">
                                    Já tem conta?{" "}
                                    <span className="font-semibold underline hover:text-neutral90 cursor-pointer" onClick={() => navigate("/")}>Login</span>
                                </p>
                            </div>
                        </form>
                    ...
                    <div className="w-full py-8 text-center text-lg text-neutral90/80 bg-DarkP1 font-secundaria">
                        Está com dificuldades para se cadastrar?{" "}
