...
import { SiMonkeytie, SiWorkplace } from "react-icons/si";
...
export const AuthBanner = ({ position = "right", effect = "fade-up" }) => {
    ...
    const authImages = [
        ...
        "https://res.cloudinary.com/dg9hqvlas/image/upload/v1744203123/student4_w2po5a.jpg",
        "https://res.cloudinary.com/dg9hqvlas/image/upload/v1744203129/student3_qjaai9.jpg",
    ];
    ...
    return (
        <div
            className={`absolute w-full lg:max-w-[50%] h-full overflow-hidden hidden lg:block ${position == "left" ? "left-0" : "right-0"
                }`}
        >
            <div
